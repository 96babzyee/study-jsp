        ...
        <div class="col-lg-10 col-xl-9 mx-auto">
          <div class="card card-signin flex-row my-5">
            ...
            <div class="card-body">
              ...
              <form class="form-join" action="join.do" method="post">
                <div class="form-label-group">
                  <input type="text" name="id" class="form-control" placeholder="UserID" required>
                  <label></label>
                </div>
                <div class="form-label-group">
                ...
                <a class="d-block text-center mt-2 small" href="login.do">Login</a>
              </form>
            </div>
          </div>
        </div>
